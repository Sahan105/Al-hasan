    ...
    <section class="section-b-space ratio_asos">
      <div class="collection-wrapper">
        <div class="container">
          <div class="row">
            <div class="col-lg-3">
              <sidebar @allFilters="allfilter" @priceVal="pricefilterArray" @categoryfilter="getCategoryFilter" :slug="this.slug"/>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="top-banner-wrapper">
                      <div v-for="bann in banner" :key="bann">
                        <a href="#">
                          <img v-if="slug == bann.id"
                          :src='bann.banner.page_banner'
                          class="img-fluid"
                          alt=""
                          />
                        </a> 
                    ...
                    <div class="collection-product-wrapper">
                          ...
                          <div class="col-12">
                            <div class="product-filter-content">
                              <div class="search-count">
                                <h5>Showing Products 1-8 of {{ product.length }} Result</h5>
                              </div>
                      ...
                      <div class="product-pagination mb-0" v-if="product.length > this.paginate">
...
export default {
  ...
  computed: {
    ...mapState({
      product: state => state.products.productslist,
      frontbanner: state => state.products.frontbanner,
      title2: state => state.products.title2,
      header: state => state.products.header,
      description2: state => state.products.description2,
      banner: state => state.products.banner
    }),
    ...mapGetters({
  ...
  mounted(){
    this.$store.dispatch('products/getBanner')
  },
  created() {
