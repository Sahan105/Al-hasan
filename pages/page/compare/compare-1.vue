                ...
                <table class="table">
                  ...
                  <tbody id="table-compare">
                    <tr>
                      ...
                      <td class="grid-link__title" v-for="(item,index) in compare" :key="index">{{item.name}}</td>
                    </tr>
                    <tr>
                      ...
                      <td class="item-row" v-for="(item,index) in compare" :key="index">
                        ...
                        <div class="product-price product_price">
                          <strong v-if="item.on_sale">On Sale:</strong>
                          <span>{{ item.sale_price * curr.curr | currency(curr.symbol) }}</span>
                        </div>
                        ...
                        <h4 class="grid-link__title hidden pt-2">{{item.name}}</h4>
                      </td>
                    </tr>
                    <tr>
