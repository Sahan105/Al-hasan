        ...
        <b-collapse id="category" visible accordion="myaccordion" role="tabpanel">
          ...
          <div class="collection-brand-filter">
            <ul class="category-list">
              ...
              :key="index">
                <nuxt-link :to="{ path: '/products/'+category.id}" @click="getCategoryFilter(category.id)">{{ category.name }}</nuxt-link>
              </li>
            </ul>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      bannerimagepath: state => state.products.bannerimagepath,
